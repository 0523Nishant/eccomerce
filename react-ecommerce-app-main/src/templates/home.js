...
const ServiceBox = ({title, children}) => (
    ...
    Digital comfort denotes the ease and comfort that people experience while using digital technology.
     It is achieved when individuals feel confident, competent and comfortable in using their digital devices.
      Digital comfort makes it easier for individuals to access information, communicate with others and carry out tasks efficiently.
     In today's world, digital comfort has become increasingly important as technology continues to play an integral role in our daily lives.
            </p>
        </div>
    </div>
)
...
const Home = () => (
    <>
        <section id="showcase" className="py-16">
            ...
            Digital comfort denotes the ease and comfort that people experience while using digital technology.
            It is achieved when individuals feel confident, competent and comfortable in using their digital devices. Digital comfort makes it easier for individuals to access information, communicate with others and carry out tasks efficiently. In today's world, digital comfort has become increasingly important as technology continues to play an integral role in our daily lives.
                    </p>
                ...
                <article id="showcase-image" className="relative hidden lg:block">
                    <img 
                        ...
                        src="https://cdn.shopify.com/s/files/1/0389/7812/5956/products/UtopiaBL3S.jpg?v=1678458395"
                    />
                    <img
                        ...
                        src="https://m.media-amazon.com/images/I/61eHnayH3iL._SL1200_.jpg"
                    />
                </article>
            </div>
        </section>
            ...
            <div className="tw-container py-14">
                ...
                <div className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                    <Panel
                        ...
                        name="vase table"
                        image="https://royaloakindia.com/media/catalog/product/r/o/royaloak-mosaic-flower-vase-for-living-room-1.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=500&width=800&canvas=800:500"
                        price={120999}
                    />
                    <Panel
                        id="rec7JInsuCEHgmaGe"
                        name="Utopia Sofa"
                        image="https://cdn.shopify.com/s/files/1/0389/7812/5956/products/UtopiaBL3S.jpg?v=1678458395"
                        price={79999}
                    />
                    <Panel
                        id="recNZ0koOqEmilmoz"
                        name="Entertainment Center"
                        image="https://m.media-amazon.com/images/I/61eHnayH3iL._SL1200_.jpg"
                        price={59999}
                    />
                </div>
